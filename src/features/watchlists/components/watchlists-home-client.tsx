      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {onCancel ? (
          <button
            type="button"
            onClick={onCancel}
            className="rounded-full px-4 py-3 text-sm text-stone-400 transition hover:text-white"
          >
            Cancel
          </button>
        ) : null}
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              {!formOpen ? (
                <button
                  ...
                  className="rounded-full border border-white/10 px-4 py-2 text-sm text-stone-400 transition hover:border-white/20 hover:text-white"
                >
                  + New watchlist
                </button>
              ) : null}
